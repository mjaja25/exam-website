...
require('./passport-setup'); // Must be required before passport usage
...
// Initialize Gemini (used in controllers, but good to keep init here if needed globally or for health checks)
...
// -------------------
const multer = require('multer'); // Needed for error check
